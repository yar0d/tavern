...
import { FIRST_NAME, MEWL, SURNAME, WOLDISH } from "@/rules/dolmenwood/languages"
import { GENDER_FEMALE, GENDER_MALE, GENDER_UNISEX, KINDRED_GRIMALKIN, KINDRED_HEIGHT_SMALL, KINDRED_TYPE_FEY, Kindred } from "."

import NAMES from "@/locales/dolmenwood/grimalkin_en-US"
...
export class Grimalkin extends Kindred {
  ...
  rollName () {
    return {
      name: rollFromObject(NAMES[FIRST_NAME]),
