...
export function setDiceLook ({ color = "#000070", labelColor = "#ffffff" } = {}) {
  $diceCore.dice.dice_color = color
  $diceCore.dice.label_color = labelColor
  $diceCore.dice.use_true_random = false
  $diceCore.dice.use_shadows = false
}

export function initialize (canvasId, color = "#000070", labelColor = "#ffffff") {
